...
func NewUpstreamMCPManager(upstream MCP, gatewaySever ToolsAdderDeleter, logger *slog.Logger, tickerInterval time.Duration, onToolsChanged OnToolsChanged) *MCPManager {
	if tickerInterval <= 0 {
